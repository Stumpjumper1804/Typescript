...
function renderItems(arr: any[]) {
  (document.getElementById("grid-anchor") as HTMLElement).innerHTML = "";
  ...
  //priority button
  let priorityButtons = document.querySelectorAll(".btn-priority") as NodeList;

  //increase priority level
  priorityButtons.forEach((element, index) => {
    console.log(typeof element);
    let btn = element as HTMLElement; //declares all buttons (button elements) as HTMLElement
...
//Sort button
const sortBtn = document.getElementById("btn-sort") as HTMLElement;
